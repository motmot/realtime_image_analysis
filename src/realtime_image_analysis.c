/* Generated by Pyrex 0.9.5.1a on Sun Mar  2 19:30:51 2008 */
...
static PyObject *__pyx_f_23realtime_image_analysis_do_bg_maint(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (__pyx_1) {
    ...
    __pyx_2 = PyFloat_FromDouble(__pyx_v_t41); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 708; goto __pyx_L1;}
    __pyx_3 = PyFloat_FromDouble(__pyx_v_t42); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 708; goto __pyx_L1;}
    __pyx_4 = PyFloat_FromDouble(__pyx_v_t43); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 708; goto __pyx_L1;}
    __pyx_5 = PyFloat_FromDouble(__pyx_v_t44); if (!__pyx_5) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 708; goto __pyx_L1;}
    __pyx_6 = PyFloat_FromDouble(__pyx_v_t45); if (!__pyx_6) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 708; goto __pyx_L1;}
    __pyx_7 = PyFloat_FromDouble(__pyx_v_t46); if (!__pyx_7) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 708; goto __pyx_L1;}
    __pyx_8 = PyFloat_FromDouble(__pyx_v_t47); if (!__pyx_8) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 708; goto __pyx_L1;}
    __pyx_9 = PyFloat_FromDouble(__pyx_v_t48); if (!__pyx_9) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 708; goto __pyx_L1;}
    __pyx_10 = PyFloat_FromDouble(__pyx_v_t49); if (!__pyx_10) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 708; goto __pyx_L1;}
    __pyx_11 = PyFloat_FromDouble(__pyx_v_t491); if (!__pyx_11) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 708; goto __pyx_L1;}
    __pyx_12 = PyFloat_FromDouble(__pyx_v_t492); if (!__pyx_12) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 708; goto __pyx_L1;}
    __pyx_13 = PyTuple_New(11); if (!__pyx_13) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 708; goto __pyx_L1;}
