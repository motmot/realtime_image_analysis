/* Generated by Pyrex 0.9.5.1a on Sat Mar  1 18:08:23 2008 */
  ...
  while (1) {
    ...
    if (__pyx_5) {
      ...
      if (__pyx_6) {
        ...
        __pyx_2 = PyObject_GetAttr(((PyObject *)((struct __pyx_obj_23realtime_image_analysis_RealtimeAnalyzer *)__pyx_v_self)->absdiff_im_roi2_view), __pyx_n_set_val); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 434; goto __pyx_L1;}
        __pyx_4 = PyInt_FromLong(0); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 434; goto __pyx_L1;}
        __pyx_8 = PyTuple_New(2); if (!__pyx_8) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 434; goto __pyx_L1;}
        PyTuple_SET_ITEM(__pyx_8, 0, __pyx_4);
        Py_INCREF(((PyObject *)__pyx_v_roi2_sz));
        PyTuple_SET_ITEM(__pyx_8, 1, ((PyObject *)__pyx_v_roi2_sz));
        __pyx_4 = 0;
        __pyx_1 = PyObject_CallObject(__pyx_2, __pyx_8); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 434; goto __pyx_L1;}
        Py_DECREF(__pyx_2); __pyx_2 = 0;
        Py_DECREF(__pyx_8); __pyx_8 = 0;
        Py_DECREF(__pyx_1); __pyx_1 = 0;
        goto __pyx_L25;
    ...
    __pyx_7 = PyObject_GetAttr(__pyx_v_all_points_found, __pyx_n_append); if (!__pyx_7) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 439; goto __pyx_L1;}
    __pyx_4 = PyFloat_FromDouble(__pyx_v_x0_abs); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 440; goto __pyx_L1;}
    __pyx_2 = PyFloat_FromDouble(__pyx_v_y0_abs); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 440; goto __pyx_L1;}
    __pyx_8 = PyFloat_FromDouble(__pyx_v_area); if (!__pyx_8) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 440; goto __pyx_L1;}
    __pyx_1 = PyFloat_FromDouble(__pyx_v_slope); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 440; goto __pyx_L1;}
    ...
    __pyx_1 = 0;
    __pyx_9 = 0;
    __pyx_4 = PyTuple_New(1); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 439; goto __pyx_L1;}
    PyTuple_SET_ITEM(__pyx_4, 0, __pyx_10);
    __pyx_10 = 0;
    __pyx_2 = PyObject_CallObject(__pyx_7, __pyx_4); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 439; goto __pyx_L1;}
    Py_DECREF(__pyx_7); __pyx_7 = 0;
    Py_DECREF(__pyx_4); __pyx_4 = 0;
    Py_DECREF(__pyx_2); __pyx_2 = 0;
